...
DATASET_PATH = (
    "/Users/kundan/Desktop/Machine Learning/"
    "placement_prediction/dataset/placement_predict_50K_Raw.csv"
)
...
#
# IMPORTANT:
# This version uses os.path.join() correctly for macOS/Linux.
#
# ================================================================
...
if target_column is None:
    ...
    print(
        "\nERROR: Target column was not automatically detected."
    )
    ...
    print(
        "\nExpected target column: PlacementStatus"
    )
...
# ================================================================
#
# Handle compatibility between different scikit-learn versions.
#
# ================================================================
...
# ================================================================
#
# Reset indexes so the actual and predicted values align correctly.
#
# ================================================================
