...
#   4. Silhouette Score
#   5. PCA visualization
#   6. Placement Cluster Matching Accuracy
#
# IMPORTANT:
...
OUTPUT_FOLDER = (
    "/Users/kundan/Desktop/Machine Learning/placement_prediction/"
    "outputs/K_Means_K++Means_Elbow_Silhoute_M4_Outputs"
)
...
for feature in required_features:
    ...
    if normalized_feature in normalized_columns:
        ...
        feature_columns.append(
            normalized_columns[normalized_feature]
        )
...
def cluster_matching_accuracy(
    ...
    for cluster in cluster_values.unique():
        ...
        cluster_targets = true_values[
            cluster_values == cluster
        ]

        majority = cluster_targets.mode().iloc[0]

        cluster_map[cluster] = majority

    predicted_values = cluster_values.map(
        cluster_map
    ).astype(str)
...
if target_column is not None:
    ...
    print(
        "\nNo PlacementStatus column was found."
    )
...
print("\nK-Means++:")
print(KMEANS_PP_FOLDER)

print("\nElbow:")
print(ELBOW_FOLDER)

print("\nSilhouette:")
print(SILHOUETTE_FOLDER)

print("\nAccuracy:")
print(ACCURACY_FOLDER)
