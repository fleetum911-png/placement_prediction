...
df = pd.read_csv("/Users/kundan/Desktop/Machine Learning/placement_prediction/dataset/clean_target_encode_M2.csv")
...
final_output.to_csv(
   "/Users/kundan/Desktop/Machine Learning/placement_prediction/dataset/clean_embedded_encode_M2.csv",
   index=False
)
